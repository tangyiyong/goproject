...
const (
	...
	MSG_PLAYER_CARRY_REQ  = 23 //玩家操作水晶请求
	MSG_PLAYER_CARRY_ACK  = 24 //开始操作水晶回复
	MSG_NEW_SKILL_NTY     = 25 //服务器更新技能通知
	MSG_REVIVE_NTY        = 26 //玩家复活的通知消息
	MSG_PLAYER_QUERY_REQ  = 27 //玩家查询水晶品质
	MSG_PLAYER_QUERY_ACK  = 28 //玩家查询水晶品质回复
	MSG_PLAYER_CHANGE_REQ = 29 //玩家请求置换水晶
	MSG_PLAYER_CHANGE_ACK = 30 //玩家请求置换水晶回复
	MSG_PLAYER_REVIVE_REQ = 31 //玩家请求复活
	MSG_PLAYER_REVIVE_ACK = 32 //玩家请求复活回复
	MSG_KILL_EVENT_REQ    = 33 //玩家杀伤事件请求
	MSG_KILL_EVENT_ACK    = 34 //玩家杀伤事件回复
	MSG_LOAD_CAMPBAT_REQ  = 35 //请求加载战斗数据
	MSG_LOAD_CAMPBAT_ACK  = 36 //请求加载战斗数据回复
	MSG_ALL_DIE_NTY       = 37 //玩家英雄全部死亡通知
	MSG_CAMPBAT_CHAT_REQ  = 38 //阵营战聊天请求
	MSG_CAMPBAT_CHAT_ACK  = 39 //阵营战聊天回复
