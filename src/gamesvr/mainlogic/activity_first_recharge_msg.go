...
//! 玩家查询首冲活动信息
func Hand_QueryActivityFirstRechargeInfo(w http.ResponseWriter, r *http.Request) {
	...
	if G_GlobalVariables.IsActivityOpen(player.ActivityModule.FirstRecharge.ActivityID) == false {
