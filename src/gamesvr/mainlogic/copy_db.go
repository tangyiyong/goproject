...
func (main_copy *TCopyMoudle) DB_UpdateMainCopyAt(copyindex int) {
	...
	GameSvrUpdateToDB("PlayerCopy", &bson.M{"_id": main_copy.PlayerID}, &bson.M{"$set": bson.M{
...
func (daily_copy *TCopyMoudle) DB_UpdateDailyCopyMask(index int, mask bool) {
	...
	GameSvrUpdateToDB("PlayerCopy", &bson.M{"_id": daily_copy.PlayerID}, &bson.M{"$set": bson.M{
		filedName: mask}})
}
...
func (famous_copy *TCopyMoudle) DB_UpdateFamousCopyBattleTimes(chapter int, copyIndex int, battleTimes int) {
	...
	GameSvrUpdateToDB("PlayerCopy", &bson.M{"_id": famous_copy.PlayerID}, &bson.M{"$set": bson.M{
...
func (famous_copy *TCopyMoudle) DB_IncFamousCopy(chapter int, famousCopy TFamousCopy) {
	...
	GameSvrUpdateToDB("PlayerCopy", &bson.M{"_id": famous_copy.PlayerID}, &bson.M{"$push": bson.M{
		filedname: famousCopy}})
}

func (self *TCopyMoudle) DB_UpdateCopy() {
	GameSvrUpdateToDB("PlayerCopy", &bson.M{"_id": self.PlayerID}, &bson.M{"$set": bson.M{
		"main":     self.Main,
		"elite":    self.Elite,
		"daily":    self.Daily,
		"famous":   self.Famous,
...
func (elite_copy *TCopyMoudle) DB_UpdateEliteInvadeTime() {
	GameSvrUpdateToDB("PlayerCopy", &bson.M{"_id": elite_copy.PlayerID}, &bson.M{"$set": bson.M{
...
func (main_copy *TCopyMoudle) DB_AddMainChapterInfo(chapter TMainChapter) {
	GameSvrUpdateToDB("PlayerCopy", &bson.M{"_id": main_copy.PlayerID}, &bson.M{"$push": bson.M{"main.chapter": chapter}})
...
func (elite_copy *TCopyMoudle) DB_AddEliteChapterInfo(chapter TEliteChapter) {
	GameSvrUpdateToDB("PlayerCopy", &bson.M{"_id": elite_copy.PlayerID}, &bson.M{"$push": bson.M{"elite.chapter": chapter}})
...
func (main_copy *TCopyMoudle) DB_AddMainCopyInfo(copyInfo TMainCopy) {
	GameSvrUpdateToDB("PlayerCopy", &bson.M{"_id": main_copy.PlayerID}, &bson.M{"$push": bson.M{"main.copyinfo": copyInfo}})
...
func (elite_copy *TCopyMoudle) DB_AddEliteCopyInfo(copyInfo TEliteCopy) {
	GameSvrUpdateToDB("PlayerCopy", &bson.M{"_id": elite_copy.PlayerID}, &bson.M{"$push": bson.M{"elite.copyinfo": copyInfo}})
...
func (elite_copy *TCopyMoudle) DB_AddEliteInvade(chapter int) {
	GameSvrUpdateToDB("PlayerCopy", &bson.M{"_id": elite_copy.PlayerID}, &bson.M{"$push": bson.M{"elite.invadechapter": chapter}})
}

func (elite_copy *TCopyMoudle) DB_RemoveEliteInvade(chapter int) {
	GameSvrUpdateToDB("PlayerCopy", &bson.M{"_id": elite_copy.PlayerID}, &bson.M{"$pull": bson.M{"elite.invadechapter": chapter}})
}
